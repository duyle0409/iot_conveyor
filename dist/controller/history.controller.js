...
const index = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    //Pagination 
    const countRecord = yield session_model_1.default.countDocuments();
    const pagination = (0, pagination_helper_1.PaginationHelper)(req, countRecord, 5);
    // 3. Sắp xếp
    let sortOptions = {};
    if (sortBy) {
        // order = 'asc' hoặc 'desc'
    ...
    const sessionList = yield session_model_1.default.find(query).sort(sortOptions).limit(pagination.limit).skip((_a = pagination.skip) !== null && _a !== void 0 ? _a : 0);
